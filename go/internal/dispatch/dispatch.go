...
const (
	...
	ToolAR
	ToolRanlib
	// ToolObjtool: kbuild rewrites each object in place after
	...
	ToolLD
	// ToolObjcopy: kbuild's generic object rewrite
	// (scripts/Makefile.lib cmd_objcopy), used for symbol prefixing in
	// arch/x86/boot/startup and drivers/firmware/efi/libstub.
	ToolObjcopy
)
